...
@Configuration
@MapperScan(basePackages = {"com.chat.mapper"}, sqlSessionFactoryRef = "oneSqlSessionFactory")
public class DruidDataSourceConfig1 {
    ...
    public DataSourceTransactionManager oneransactionManager(@Qualifier("one") DataSource dataSource) {
